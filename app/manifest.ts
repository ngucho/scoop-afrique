...
export default function manifest(): MetadataRoute.Manifest {
  ...
  categories: ['news', 'entertainment', 'lifestyle', 'media', 'tv', 'radio', 'podcast', 'video', 'music'],
    ...
    // Image pour illustrer le media (install PWA, partage, découverte)
    screenshots: [
      {
        src: '/icon-512x512.png',
        sizes: '512x512',
        type: 'image/png',
        label: 'Scoop.Afrique - Le media digital africain',
        form_factor: 'narrow',
      },
      {
        src: '/icon-512x512.png',
    ...
    // Mots-clés pour référencement (non standard W3C, conservés pour user agents qui les lisent)
    keywords: [
      'Scoop Afrique',
      'Scoop.Afrique',
      'media africain',
