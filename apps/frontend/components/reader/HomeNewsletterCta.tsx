...
export function HomeNewsletterCta() {
  return (
    <MotionEnter as="section" className="my-14 w-full min-w-0 max-w-full">
      <div className="flex min-w-0 max-w-full flex-col gap-6 rounded-2xl border border-border/50 border-l-8 border-l-primary bg-muted p-5 sm:gap-8 sm:p-8 md:flex-row md:items-center md:p-10">
