...
import { SectionHeader, Button } from 'scoop'
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12 lg:px-20">
        ...
        <div className="mb-12 flex flex-wrap gap-4">
          {platforms.map((platform) => (
            <Button
              key={platform.key}
              type="button"
              variant={activePlatform === platform.key ? 'default' : 'outline'}
              size="default"
        ...
        <div className="mt-16 border border-border bg-card p-6 md:p-8">
          <div className="mb-6 flex items-center gap-4">
            <div className="flex h-10 w-10 items-center justify-center rounded bg-[#FF0000]">
