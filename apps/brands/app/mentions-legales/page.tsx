  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <article className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mb-12 text-muted-foreground">Dernière mise à jour : Mars 2026</p>
        <div className="space-y-8">
          <section>
            ...
            <ul className="list-none space-y-1 text-muted-foreground">
              ...
              <li><strong>RCCM</strong> : CI-ABJ-03-2025-B12058-06, Abidjan</li>
              ...
              <li><strong>Associés et gérants</strong> : M. TAGBA Guy-Landry Jean Armel Kouadio (51 %, Fondateur &amp; Directeur Éditorial) ; Mlle METSEBO Ines Laure (49 %, Co-fondatrice &amp; Directrice Générale)</li>
              <li><strong>Directeur de la publication</strong> : TAGBA Guy-Landry Jean Armel Kouadio</li>
            </ul>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              L&apos;ensemble du contenu de ce site (textes, images, vidéos, logos, graphismes, icônes, etc.) est la propriété exclusive de SCOOP AFRIQUE SARL ou de ses partenaires, sauf mention contraire. Toute reproduction, representation, modification, publication, transmission, ou exploitation de tout ou partie du contenu de ce site, par quelque procédé que ce soit, sans l&apos;autorisation préalable écrite de SCOOP AFRIQUE SARL, est strictement interdite. Le nom &quot;SCOOP AFRIQUE&quot; est une marque.
            </p>
          </section>
          <section>
