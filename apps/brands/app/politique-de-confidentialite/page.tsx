        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              SCOOP AFRIQUE SARL s&apos;engage à protéger la vie privée de ses utilisateurs. Cette politique explique comment nous collectons, utilisons, partageons et protégeons vos informations personnelles.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">Email : contact@scoop-afrique.com — Adresse : Abidjan, Cocody Riviera Faya, Côte d&apos;Ivoire</p>
          </section>
        </div>
      </article>
      <Footer />
