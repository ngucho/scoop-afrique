 ...
 *
 * Usage (depuis apps/brands) : node scripts/resize-publications.mjs
 * Ou depuis la racine : node apps/brands/scripts/resize-publications.mjs
 * (nécessite : pnpm add -D sharp dans apps/brands)
 */
...
async function resize() {
  ...
  try {
    ...
    console.error('Installez sharp dans apps/brands : pnpm add -D sharp --filter @scoop-afrique/brands')
    process.exit(1)
  }
