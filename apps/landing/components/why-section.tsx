...
import { GlitchText, MarqueeBand, SectionHeader } from 'scoop'

const features = [
  { number: "01", title: "INFORMATION VÉRIFIÉE", description: "Chaque information est sourcée, vérifiée et contextualisée avant publication.", stat: "100%", statLabel: "Fact-checked" },
  { number: "02", title: "DONNÉES EXCLUSIVES", description: "Des analyses approfondies avec des chiffres et statistiques inédites sur l'Afrique.", stat: "490M+", statLabel: "Vues totales" },
  { number: "03", title: "FORMAT NATIF", description: "Contenu optimisé pour chaque plateforme : TikTok, Instagram, YouTube, Threads.", stat: "5", statLabel: "Plateformes" },
  { number: "04", title: "VOIX AFRICAINE", description: "Une perspective authentique, par des Africains, pour les Africains et le monde.", stat: "12+", statLabel: "Pays touchés" },
]
    ...
    <section ref={sectionRef} className="relative overflow-hidden bg-card">
      ...
      <div className="relative py-24 md:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12 lg:px-20">
          <SectionHeader number="002" label="POURQUOI NOUS" className="mb-20" />
              ...
              >
                ...
                <span
                  className={`mb-6 block font-mono text-7xl font-black transition-colors duration-300 md:text-8xl ${
                    hoveredFeature === index ? "text-primary" : "text-muted/20"
                  }`}
                >
                  {feature.number}
                </span>
