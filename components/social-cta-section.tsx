...
const socialPlatforms = [
  {
    name: "TikTok",
    handle: "@Scoop.Afrique",
    href: "https://tiktok.com/@Scoop.Afrique",
    followers: "837.5K",
    gradient: "from-cyan-400 via-pink-500 to-red-500",
    description: "Videos virales & trends africains",
  },
  {
    name: "Facebook",
    handle: "@scoop.afrique",
    href: "https://facebook.com/scoop.afrique",
    followers: "359K",
    gradient: "from-blue-600 to-blue-400",
    description: "Communaute & actualites",
  },
  {
    name: "Threads",
    handle: "@Scoop.Afrique",
    ...
    description: "Conversations & opinions",
  },
  {
    name: "Instagram",
    handle: "@Scoop.Afrique",
    ...
    description: "Stories & reels exclusifs",
  },
  {
    name: "YouTube",
    handle: "@Scoop.Afrique",
    ...
    description: "Reportages & analyses video",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          className={`absolute inset-0 bg-gradient-to-br opacity-5 transition-all duration-1000 ${socialPlatforms[activeIndex].gradient}`}
        />
      </div>
            ...
            >
              <div className="relative z-10">
                <div className="mb-4 flex items-center justify-between">
                  <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground transition-colors group-hover:text-primary-foreground/70">
                    Plateforme vedette
                  </span>
                  <span className="font-mono text-2xl font-black text-primary transition-colors group-hover:text-primary-foreground">
                    {socialPlatforms[activeIndex].followers}
                  </span>
                </div>
                <h3 className="mb-2 font-sans text-3xl font-black uppercase text-foreground transition-colors group-hover:text-primary-foreground md:text-4xl">
                  {socialPlatforms[activeIndex].name}
                </h3>
                <p className="text-muted-foreground transition-colors group-hover:text-primary-foreground/70">
                  {socialPlatforms[activeIndex].description}
                </p>
              </div>
            ...
            {socialPlatforms.map((platform, index) => (
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h4
                      className={`font-sans text-xl font-bold uppercase tracking-wider transition-colors md:text-2xl ${
                        activeIndex === index
                          ? "text-primary"
                          : "text-foreground"
                      }`}
                ...
                <div className="flex items-center gap-4">
                  <span className="font-sans text-xl font-black text-primary md:text-2xl">
                    {platform.followers}
                  </span>
                  <div
        ...
        <div className="mt-24 border border-border bg-card p-8 md:p-12">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            ...
            <a
              ...
              className="group relative overflow-hidden border-2 border-primary bg-transparent px-8 py-4 font-mono text-sm uppercase tracking-widest text-primary transition-all duration-300 hover:text-primary-foreground"
              data-hover
            >
              <span className="relative z-10">Contact@scoop-afrique.com</span>
